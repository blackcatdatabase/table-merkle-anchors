...
> Schema package for table **merkle_anchors** (repo: `merkle-anchors`).
...
|-------:|:-----|:----:|:--------|:------|
| id | BIGINT | — | AS | PK |
| merkle_root_id | BIGINT | NO | — |  |
| anchor_type | TEXT | NO | — |  |
| anchor_ref | VARCHAR(512) | NO | — |  |
| anchored_at | TIMESTAMPTZ(6) | NO | CURRENT_TIMESTAMP(6) |  |
| meta | JSONB | YES | — |  |

## Relationships
- FK → **merkle_roots** via (merkle_root_id) (ON DELETE CASCADE).
...
erDiagram
  ...
  MERKLE_ANCHORS }o--|| MERKLE_ROOTS : "merkle_root_id"
```
