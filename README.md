...
| Pkg folder | [packages\merkle-anchors](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\merkle-anchors) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package merkle-anchors -Apply
