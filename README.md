...
- Pkg folder: [packages\merkle-anchors](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\merkle-anchors)
...
graph LR
  ...
  merkle_anchors["merkle_anchors"]:::center
  merkle_anchors -->|FK| merkle_roots["merkle_roots"]:::link
...
- Outbound (depends on): "merkle_roots"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package merkle-anchors -Apply
