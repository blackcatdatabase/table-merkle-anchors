...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'merkle_anchors'; }
    public static function contractView(): string { return 'vw_merkle_anchors'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'merkle_root_id', 'anchor_type', 'anchor_ref', 'anchored_at', 'meta' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'merkle_root_id', 'anchor_type', 'anchor_ref' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'merkle_root_id' ]; }
