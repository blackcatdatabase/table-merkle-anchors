...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'merkle_root_id', 'anchor_type', 'anchor_ref', 'anchored_at', 'meta' ];
    }
    ...
    {
        $x = [ 'id', 'merkle_root_id', 'anchor_type', 'anchor_ref', 'anchored_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\MerkleAnchors\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\MerkleAnchors\Definitions::softDeleteColumn();
