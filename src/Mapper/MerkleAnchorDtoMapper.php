...
namespace BlackCat\Database\Packages\MerkleAnchors\Mapper;

use BlackCat\Database\Packages\MerkleAnchors\Dto\MerkleAnchorDto;
use BlackCat\Database\Packages\MerkleAnchors\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO MerkleAnchorDto:
...
final class MerkleAnchorDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'merkle_root_id' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [ 'meta' ];
    /** @var string[] */
    private const DATE_COLS   = [ 'anchored_at' ];
    /** @var string[] */
     ...
     * @return MerkleAnchorDto
     */
    public static function fromRow(array $row): MerkleAnchorDto
    {
        /** @var MerkleAnchorDto */
        return DtoHydrator::fromRow(
            MerkleAnchorDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?MerkleAnchorDto
    {
     ...
     *
     * @param MerkleAnchorDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(MerkleAnchorDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(MerkleAnchorDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(MerkleAnchorDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,MerkleAnchorDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,MerkleAnchorDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(MerkleAnchorDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,MerkleAnchorDto>
     */
