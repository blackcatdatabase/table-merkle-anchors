...
final class MerkleAnchorsModule implements ModuleInterface
{
    public function name(): string { return 'table-merkle_anchors'; }
    public function table(): string { return 'merkle_anchors'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-merkle_roots' ]; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedFk  = [ 'fk_merkle_anchor_root' ];
