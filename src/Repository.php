...
namespace BlackCat\Database\Packages\MerkleAnchors;
...
use BlackCat\Database\Packages\MerkleAnchors\Repository\MerkleAnchorRepository as GeneratedRepository;
...
{
  private MerkleAnchorRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof MerkleAnchorRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected MerkleAnchorRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\MerkleAnchors\Dto\MerkleAnchorDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\MerkleAnchors\Dto\MerkleAnchorDto|null { return $this->repo->getById($id, $asDto); }
