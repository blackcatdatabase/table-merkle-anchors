...
{
    private MerkleAnchorRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new MerkleAnchorRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\MerkleAnchors\Dto\MerkleAnchorDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\MerkleAnchors\Dto\MerkleAnchorDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\MerkleAnchors\Dto\MerkleAnchorDto|null
    {
