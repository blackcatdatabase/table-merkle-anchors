...
namespace BlackCat\Database\Packages\MerkleAnchors\Dto;
 ...
 */
final class MerkleAnchorDto implements \JsonSerializable {
    public function __construct(
        public readonly int $id,
        public readonly int $merkleRootId,
        public readonly string $anchorType,
        public readonly string $anchorRef,
        public readonly \DateTimeImmutable $anchoredAt,
